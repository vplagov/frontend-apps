          ...
          <div class="flex justify-between h-16">
            <div class="flex">
              <div class="flex-shrink-0 flex items-center">
                <span class="text-xl font-bold text-indigo-600 dark:text-indigo-400">RSS Feed</span>
              </div>
              <div class="sm:ml-6 flex space-x-4 sm:space-x-8">
                <a routerLink="/posts" routerLinkActive="border-indigo-500 text-gray-900 dark:text-white"
                ...
                <a routerLink="/blogs" routerLinkActive="border-indigo-500 text-gray-900 dark:text-white"
                   class="border-transparent text-gray-500 dark:text-gray-400 hover:border-gray-300 dark:hover:border-gray-600 hover:text-gray-700 dark:hover:text-gray-200 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium">
                  Blogs
                </a>
              </div>
